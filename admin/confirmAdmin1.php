        ...
        <div class="container">
            ...
            if (isset($success)) {
                ?>
                 ...
                 <font color="green" align="center"><?= $success ?></font> <?php } ?>
            <?php
            if (isset($error)) {
                ?>
  
                 <font color="red" align="center"><?= $error ?></font> <?php } ?>
...
<div class="form-group">
 ...
 <button type="submit" name="submit" id="submit" class="btn btn-primary">Submit</button>
     ...
     <h4><b><font color="red" align="centre">Already Registerd? Sign In </font></b></h4>
