 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 style="font-weight: 900;border-bottom: 2px solid #000000; padding-bottom: 20px;">Manage Students  </h1>
                    </div>
                </div>
                <div class="row" >
...
<button class="btn btn-primary"><i class="fa fa-edit "></i> Check Profile</button> </a>                                        
